...
},{"ml-matrix":6}],2:[function(require,module,exports){
"use strict";
...
class Matrix extends AbstractMatrix {
  ...
  constructor(nRows, nColumns) {
    ...
    if (Matrix.isMatrix(nRows)) {
      this.__initData(nRows.rows, nRows.columns);
      Matrix.copy(nRows, this);
    } else if (Number.isInteger(nRows) && nRows >= 0) {
      this.__initData(nRows, nColumns);
...
class SymmetricMatrix extends AbstractMatrix {
  ...
  get size() {
    return this.__matrix.size;
  }

  get rows() {
    return this.__matrix.rows;
  }

  get columns() {
    return this.__matrix.columns;
  }
  ...
  constructor(diagonalSize) {
    ...
    if (Matrix.isMatrix(diagonalSize)) {
      ...
      this.__matrix = Matrix.copy(
        diagonalSize,
        new Matrix(diagonalSize.rows, diagonalSize.rows),
      );
    } else if (Number.isInteger(diagonalSize) && diagonalSize >= 0) {
      this.__matrix = new Matrix(diagonalSize, diagonalSize);
    } else {
      this.__matrix = new Matrix(diagonalSize);
  ...
  get(rowIndex, columnIndex) {
    return this.__matrix.get(rowIndex, columnIndex);
  }
  set(rowIndex, columnIndex, value) {
    // symmetric set
    this.__matrix.set(rowIndex, columnIndex, value);
    this.__matrix.set(columnIndex, rowIndex, value);
  ...
  removeCross(index) {
    ...
    this.__matrix.removeRow(index);
    this.__matrix.removeColumn(index);
  ...
  addCross(index, array) {
    ...
    this.__matrix.addRow(index, row);
    this.__matrix.addColumn(index, array);
